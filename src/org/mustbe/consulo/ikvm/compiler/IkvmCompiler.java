 ...
 */
@Logger
public class IkvmCompiler implements TranslatingCompiler
{
	@NotNull
	@Override
	...
	public boolean isCompilableFile(VirtualFile virtualFile, CompileContext compileContext)
	{
		...
		IkvmModuleExtension extension = ModuleUtilCore.getExtension(moduleForFile, IkvmModuleExtension.class);
		return extension != null && virtualFile.getFileType() == JavaFileType.INSTANCE;
	}
	...
	public void compile(CompileContext compileContext, Chunk<Module> moduleChunk, VirtualFile[] virtualFiles, OutputSink outputSink)
	{
		...
		IkvmModuleExtension<?> langDotNetModuleExtension = ModuleUtilCore.getExtension(module, IkvmModuleExtension.class);
